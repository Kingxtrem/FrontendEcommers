...
const HeroSection = () => (
    <section className="bg-gradient-to-br rounded-xl from-blue-100 to-green-100 py-16 px-4 flex flex-col items-center text-center">
        ...
        <div className="flex gap-4">
            <Link to="/products">
                <button className='animate-bounce hover:animate-none rounded-xl text-3xl p-3 bg-blue-700 text-white cursor-pointer hover:bg-blue-800 active:bg-blue-950 transition duration-300 text-nowrap'>Shop Now</button>
            </Link>
        </div>
    </section>
);
