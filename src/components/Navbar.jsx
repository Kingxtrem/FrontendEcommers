    ...
    <div className='bg-slate-950 p-2 text-white font-bold w-full'>
      <div className='flex justify-between items-start md:items-center'>
        ...
        <div className='flex flex-col md:flex-row justify-end items-end'>
          ...
          <div className={`${menuOpen ? "flex" : "hidden"} md:flex flex-col md:flex-row items-end md:items-center justify-evenly md:gap-7 md:mt-0 absolute top-15 right-0 rounded-lg md:static bg-slate-950 p-2 md:p-0 h-screen w-screen md:w-auto md:h-fit opacity-80 md:opacity-100 `}>
