...
const Footer = () => {
    return (
        <div className='sticky bottom-0 bg-slate-950 text-white p-2 font-bold w-auto flex-col justify-items-centercenter items-center text-[10px] md:text-xl'>
            <div className='w-full text-center'> Follow us on:</div>
