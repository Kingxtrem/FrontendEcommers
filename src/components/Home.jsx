    ...
    <div className='bg-slate-700 text-white min-h-screen flex items-center justify-center'>
      <div className='container mx-auto px-4 py-4 text-center'>
        ...
        <div className='flex justify-center items-center'>
          <button className='animate-bounce m-5 rounded-xl text-2xl p-2 bg-blue-700 text-white cursor-pointer hover:bg-blue-800 active:bg-blue-950 transition duration-300' onClick={productPage}>Get Started</button>
        </div>
      </div>
    </div>
  )
