          ...
          return (
            <div key={item._id} className='container p-3 border-2 border-blue-500 rounded-2xl m-5 box-content bg-white md:flex gap-5'>
              ...
              <div className='text-black text-xs mx-auto container p-5'>
                <p className='m-5 break-words'><span className='font-bold'>Product Name:</span> {item.name}</p>
                <p className='m-5 break-words'><span className='font-bold'>Product Description:</span> {item.description}</p>
