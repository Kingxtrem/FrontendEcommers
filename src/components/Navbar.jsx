...
const Navbar = ({
  ...
  return (
    <div
      className="bg-gray-200 p-1 font-bold text-sm w-full z-50 sticky top-0"
    ...
    >
      <div className="flex justify-between items-start md:items-center">
        <NavLink
          ...
          className={({ isActive }) =>
            isActive
              ? "text-red-500 rounded-lg cursor-pointer hover:bg-blue-800 hover:text-white px-5 py-2.5"
              : "cursor-pointer hover:bg-blue-800 hover:text-white rounded-lg px-5 py-2.5"
          }
        >
          <div className="flex items-center">
            <img
              className="w-10 border-0 rounded-full mr-1 cursor-pointer"
              src={TechCart}
              alt="TechCart Logo"
            />
        ...
        <div className="flex flex-col md:flex-row justify-center items-center">
          <div
            className="md:hidden cursor-pointer hover:bg-blue-800 rounded-lg px-5 py-2.5 text-3xl"
            onClick={(e) => {
              toggleMenu(e);
            }}
          >
            ...
            >
              ...
              <div className="flex justify-end mb-4 md:hidden">
                <button
                  ...
                  className="text-2xl p-2 hover:text-red-600"
                >
                  <IoMdClose />
                </button>
              </div>
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  isActive
                    ? " text-red-500 rounded-lg cursor-pointer hover:bg-blue-800"
                    : "cursor-pointer hover:bg-blue-800 hover:text-white rounded-lg"
                }
              >
              ...
              <div
                className="text-center relative flex items-center cursor-pointer hover:bg-blue-800 hover:text-white rounded-lg px-5 md:px-0 py-2.5 w-40 md:w-30 md:justify-center justify-start"
                onClick={(e) => toggleDropdown1(e)}
              >
                ...
                <div
                  ...
                  } bg-gray-200 text-black rounded-lg absolute top-full w-30`}
                >
                  ...
                  <div className="text-sm">
                    <div>
                      <Link
                        ...
                        className="block px-5 py-2.5 hover:bg-black hover:text-white"
                        onClick={() => {
                          setMenuOpen(false);
                        }}
                      >
              ...
              >
                <div className="relative flex items-center cursor-pointer hover:bg-blue-800 rounded-lg px-5 md:px-0 py-2.5 w-40 md:w-30 md:justify-center justify-start">
                  ...
                  <span className="absolute top-1 left-18 md:left-22 text-white bg-gray-700  rounded-full px-1 ">
